                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="name" class="form-control" placeholder="Nama User" value="<?php echo e($user->name); ?>" required="required">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row <?php echo e($errors->has('email') ? 'has-error' : ''); ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" name="email" class="form-control" placeholder="Email User" value="<?php echo e($user->email); ?>" required="required">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row <?php echo e($errors->has('password-repeat') ? 'has-error' : ''); ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="password" name="password-repeat" class="form-control" placeholder="Ulangi Password" value="<?php echo e(old('password-repeat')); ?>">
