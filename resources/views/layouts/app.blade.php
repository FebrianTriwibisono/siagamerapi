...
<head>
    ...
    <title> Siaga Merapi </title> <!--{{ config('app.name', 'FullCash') }}-->
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                       <font size="5" color="blue">Siaga Merapi</font><!-- {{ config('app.name', 'FullCash') }} -->
                    </a>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <a class="navbar-brand" href="{{url('/user')}}">Admin |</a>
                    <a class="navbar-brand" href="{{url('/record')}}">Rekaman </a>     
