...
<link href="{{ asset('css/app.css') }}" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#home"><img src="{{ asset('depan/img/logo2.png') }}" width="150" height="50"></a>
        ...
        <div id="cover" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="fill" src="{{ asset('depan/img/1.jpg') }}" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="fill" src="{{ asset('depan/img/2.jpg') }}" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="fill" src="{{ asset('depan/img/3.jpg') }}" alt="Third slide">
            </div>
          </div>
        </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div  class="col-md-6 mx-auto" align="center">
            ...
            <p  class="isi"><i>*Berdasarkan pengamatan pada {{$data->tgl}}</i></p>
          </div>
          <div class="col-md-6 mx-auto" align="center">
            ...
            <table  class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>{{$data->intensitas_gas}} Tons</td>
                </tr>
                <tr>
                  <td>2</th>
                  <td>Suhu</td>
    ...
    <!-- Plugin JavaScript -->
    <script src="{{ asset('depan/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
